...
const content = {
  title: "Triple Arch Expansion Joints",
  metaDescription: "Triple arch rubber expansion joints for maximum axial movement and extreme thermal expansion compensation. EPDM rubber construction.",
  heroDescription: "Maximum movement capability with three arch design for demanding applications requiring extreme thermal expansion compensation.",
  longDescription: "Triple arch expansion joints provide the highest level of axial movement compensation. The three-arch design offers exceptional flexibility for applications with extreme temperature variations or significant pipe movement requirements.",
  features: ["Maximum axial movement", "Extreme thermal expansion compensation", "EPDM rubber construction", "High flexibility", "Nylon reinforced", "Multiple flange options"],
  applications: ["High-temperature systems", "Power plants", "Industrial processes", "Extreme thermal cycling"],
}

export const metadata: Metadata = {
  title: `${content.title} | Dewater Products`,
  description: content.metaDescription,
  alternates: { canonical: "https://dewaterproducts.com.au/triple-arch-expansion-joints" },
}

export const revalidate = 60

export default async function TripleArchExpansionJointsPage() {
