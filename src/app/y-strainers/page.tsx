...
const content = {
  title: "Y Strainers",
  metaDescription: "Y strainers in 316 stainless steel and cast iron. Pipeline filtration for pump protection. ANSI 150LB and PN16 flanged.",
  ...
  longDescription: "Y strainers provide economical pipeline filtration where debris levels are low. The Y-shaped body allows horizontal or vertical installation. 316SS for corrosive fluids, cast iron for general water service.",
  features: ["Compact Y-pattern design", "Horizontal or vertical install", "316SS or cast iron", "Removable SS mesh screen", "1mm mesh standard", "ANSI 150LB / PN16"],
