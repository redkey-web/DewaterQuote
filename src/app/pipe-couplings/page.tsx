...
export const metadata: Metadata = {
  title: "Clamps & Couplings - Pipe Couplings & Repair Clamps",
  description:
    "Professional pipe couplings, repair clamps, and flange adaptors for reliable pipe connections. Straub and Orbit brands available for Australian industry.",
}
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl">
            Professional pipe couplings, repair clamps, and flange adaptors for reliable pipe
            connections. Our range includes solutions from leading brands Straub and Orbit.
          </p>
        </div>
