...
export const metadata: Metadata = {
  ...
  description:
    "Browse our complete range of industrial pipe couplings, valves, repair clamps, expansion joints and strainers. Orbit, Straub, and premium brands for Australian industry.",
}
      ...
      <section className="bg-gradient-to-b from-muted/50 to-background py-12 border-b">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl">
            Browse our comprehensive selection of industrial pipe fittings, valves, and
            accessories. All products available for immediate quotation with fast Australia-wide
            delivery.
          </p>
        </div>
      </section>
      ...
      <section className="bg-muted/50 border-t py-12">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-muted-foreground mb-6">
            Our team can source specialist products and provide custom solutions for your
