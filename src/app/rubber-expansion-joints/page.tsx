...
export const metadata: Metadata = {
  title: "Expansion Joints - Rubber, PTFE & Stainless Steel",
  description:
    "Flexible pipe connections for thermal expansion, vibration absorption, and misalignment compensation. Available in rubber, PTFE, stainless steel, and fabric materials.",
}
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="mb-8">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl">
            Flexible pipe connections for thermal expansion, vibration absorption, and misalignment
            compensation. Available in rubber, PTFE, stainless steel, and fabric materials.
          </p>
        </div>
