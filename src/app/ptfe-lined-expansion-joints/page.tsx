...
const content = {
  title: "PTFE Lined Expansion Joints",
  metaDescription: "PTFE lined rubber expansion joints for chemical resistance. Teflon-lined for aggressive media. EPDM rubber with PTFE inner lining.",
  heroDescription: "PTFE (Teflon) lined expansion joints for chemical and aggressive media applications requiring superior corrosion resistance.",
  longDescription: "PTFE lined expansion joints feature a Teflon inner lining that provides exceptional chemical resistance. Ideal for applications involving aggressive chemicals, acids, or media that would damage standard EPDM rubber construction.",
  features: ["PTFE (Teflon) inner lining", "Superior chemical resistance", "Handles aggressive media", "EPDM outer body", "Corrosion resistant", "Wide chemical compatibility"],
  applications: ["Chemical processing", "Acid transfer", "Pharmaceutical", "Food and beverage", "Aggressive media handling"],
}

export const metadata: Metadata = {
  title: `${content.title} | Dewater Products`,
  description: content.metaDescription,
  alternates: { canonical: "https://dewaterproducts.com.au/ptfe-lined-expansion-joints" },
}

export const revalidate = 60

export default async function PtfeLinedExpansionJointsPage() {
  const products = await getProductsBySubcategory("rubber-expansion-joints", "ptfe-lined")
  const breadcrumbs = [
    { name: "Home", url: "https://dewaterproducts.com.au" },
    { name: content.title, url: "https://dewaterproducts.com.au/ptfe-lined-expansion-joints" },
  ]
