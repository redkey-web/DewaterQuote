  ...
  return (
    <div>
      ...
      >
        ...
        <div className={"absolute z-0 pointer-events-none transition-opacity duration-500 top-[69%] left-[23%] -translate-x-1/2 -translate-y-1/2 scale-[0.87] md:scale-[1.04] lg:scale-[1.18] xl:scale-[1.30] origin-center " + (isStormyFading ? "animate-stormy-fade-out" : "")} style={{ clipPath: 'circle(50% at 50% 50%)' }}>
        ...
        <div className={"absolute z-0 pointer-events-none transition-opacity duration-500 top-[69%] left-[60%] -translate-x-1/2 -translate-y-1/2 scale-[0.76] md:scale-[0.90] lg:scale-[1.01] xl:scale-[1.12] origin-center " + (isStormyFading ? "animate-stormy-fade-out" : "")} style={{ clipPath: 'circle(50% at 50% 50%)' }}>
          <div style={{ perspective: '1200px', transform: 'rotateX(10deg) rotateY(20deg)' }}>
            <div className="animate-orbit-3d-11" style={{ transformOrigin: 'center center' }}>
              <div style={{ filter: 'drop-shadow(0 0 12px rgba(103, 232, 249, 0.4))' }}>
                <div className="block md:hidden">
        ...
        <div className={"absolute z-0 pointer-events-none transition-opacity duration-500 top-[69%] left-[103%] -translate-x-1/2 -translate-y-1/2 scale-[0.46] md:scale-[0.54] lg:scale-[0.61] xl:scale-[0.68] origin-center " + (isStormyFading ? "animate-stormy-fade-out" : "")} style={{ clipPath: 'circle(50% at 50% 50%)' }}>
          <div style={{ perspective: '1200px', transform: 'rotateX(10deg) rotateY(20deg)' }}>
            <div className="animate-orbit-3d-11" style={{ transformOrigin: 'center center' }}>
              <div style={{ filter: 'drop-shadow(0 0 12px rgba(103, 232, 249, 0.4))' }}>
                <div className="block md:hidden">
