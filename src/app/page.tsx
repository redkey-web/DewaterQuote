  ...
  return (
    <div>
      ...
      >
        ...
        <div className={"absolute z-0 pointer-events-none transition-opacity duration-500 bottom-[calc(8%-180px)] left-1/2 -translate-x-1/2 md:translate-x-0 md:left-auto md:bottom-[calc(8%-237px)] md:right-[calc(-5%+66px)] " + (isStormyFading ? "animate-stormy-fade-out" : "")}>
          <div style={{ perspective: '800px' }}>
