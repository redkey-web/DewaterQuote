            ...
            <form onSubmit={handleSearchSubmit}>
              ...
              <div className="relative">
                ...
                <input
                  ref={heroInputRef}
                  type="text"
                  className="relative w-full h-14 md:h-16 pl-14 pr-6 text-lg font-bold rounded-2xl bg-white/70 backdrop-blur-sm border-2 border-primary/50 shadow-[inset_0_2px_6px_rgba(0,0,0,0.08),0_4px_12px_rgba(57,197,218,0.15)] focus:outline-none focus:border-primary focus:shadow-[inset_0_2px_6px_rgba(0,0,0,0.08),0_4px_20px_rgba(57,197,218,0.25)] transition-all"
