...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://dewaterproducts.com.au/foot-valves" },
}

export const revalidate = 60

export default async function FootValvesPage() {
  const products = await getProductsBySubcategory("valves", "foot-valve")
  const breadcrumbs = [
    { name: "Home", url: "https://dewaterproducts.com.au" },
    { name: "Valves", url: "https://dewaterproducts.com.au/industrial-valves" },
    { name: content.title, url: "https://dewaterproducts.com.au/foot-valves" },
  ]
