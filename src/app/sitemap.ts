...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/meet-the-team`, lastModified: now, changeFrequency: "monthly", priority: 0.5 },
    { url: `${BASE_URL}/brands`, lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${BASE_URL}/other-manufacturers`, lastModified: now, changeFrequency: "monthly", priority: 0.5 },
    ...
    { url: `${BASE_URL}/warranty`, lastModified: now, changeFrequency: "yearly", priority: 0.3 },
    // Hub pages
