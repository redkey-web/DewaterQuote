...
const content = {
  ...
  metaDescription: "Single sphere rubber expansion joints. EPDM rubber with zinc or 316SS flanges. Absorbs vibration and thermal expansion. PN16 rated.",
  heroDescription: "Flexible rubber joints for absorbing thermal expansion, vibration, and pipe misalignment. Single sphere design for standard movement.",
  longDescription: "Single sphere rubber expansion joints provide flexible connections that absorb thermal expansion, reduce vibration transmission, and accommodate pipe misalignment. EPDM rubber with nylon reinforcement.",
  features: ["Absorbs thermal expansion", "Reduces vibration", "WRAS approved EPDM", "Nylon reinforced", "Zinc or 316SS flanges", "PN16 rated"],
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "https://dewaterproducts.com.au/single-sphere-expansion-joints" },
}

export const revalidate = 60
export const dynamic = "force-dynamic"

export default async function SingleSphereExpansionJointsPage() {
  const products = await getProductsBySubcategory("rubber-expansion-joints", "single-sphere")
  const breadcrumbs = [
    { name: "Home", url: "https://dewaterproducts.com.au" },
    { name: "Expansion Joints", url: "https://dewaterproducts.com.au/expansion-joints" },
    { name: content.title, url: "https://dewaterproducts.com.au/single-sphere-expansion-joints" },
  ]
