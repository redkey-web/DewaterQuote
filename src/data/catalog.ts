...
export const products: Product[] = [
  // Butterfly Valves
  {
    ...
    sizeOptions: [
      { value: "50mm", label: "50mm DN50 (2\") Nominal Bore sizing", price: 400, sku: "BFLYW316-50" },
      { value: "65mm", label: "65mm", price: 500, sku: "BFLYW316-65" },
      { value: "80mm", label: "80mm DN80 (3\") Nominal Bore sizing", price: 550, sku: "BFLYW316-80" },
      { value: "100mm", label: "100mm DN100 (4\") Nominal Bore sizing", price: 600, sku: "BFLYW316-100" },
      { value: "125mm", label: "125mm", price: 800, sku: "BFLYW316-125" },
      { value: "150mm", label: "150mm", price: 900, sku: "BFLYW316-150" },
      { value: "200mm", label: "200mm", price: 1499, sku: "BFLYW316-200" },
      { value: "250mm", label: "250mm", price: 2100, sku: "BFLYW316-250" },
      { value: "300mm", label: "300mm", price: 2999, sku: "BFLYW316-300" }
    ],
  ...
  // FSF Single Sphere Rubber Expansion Joint
  {
    ...
    sizeOptions: [
      { value: "32mm", label: "DN32", price: 174, sku: "FSFREJ32" },
      { value: "40mm", label: "DN40 (1-1/2\")", price: 211, sku: "FSFREJ40" },
      { value: "50mm", label: "DN50 (2\")", price: 228, sku: "FSFREJ50" },
      { value: "65mm", label: "DN65", price: 245, sku: "FSFREJ65" },
      { value: "80mm", label: "DN80 (3\")", price: 304, sku: "FSFREJ80" },
      { value: "100mm", label: "DN100 (4\")", price: 404, sku: "FSFREJ100" },
      { value: "125mm", label: "DN125 (5\")", price: 473, sku: "FSFREJ125" },
      { value: "150mm", label: "DN150 (6\")", price: 539, sku: "FSFREJ150" },
      { value: "200mm", label: "DN200 (8\")", price: 674, sku: "FSFREJ200" },
      { value: "250mm", label: "DN250 (10\")", price: 809, sku: "FSFREJ250" },
      { value: "300mm", label: "DN300 (12\")", price: 1052, sku: "FSFREJ300" },
      { value: "350mm", label: "DN350 (14\")", price: 1619, sku: "FSFREJ350" },
      { value: "400mm", label: "DN400 (16\")", price: 1985, sku: "FSFREJ400" },
      { value: "450mm", label: "DN450 (18\")", price: 2423, sku: "FSFREJ450" },
      { value: "500mm", label: "DN500 (20\")", price: 3375, sku: "FSFREJ500" },
      { value: "600mm", label: "DN600 (24\")", price: 3510, sku: "FSFREJ600" }
    ],
