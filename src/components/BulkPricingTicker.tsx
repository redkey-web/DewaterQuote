        ...
        <div className="ticker-content">
          <div className="flex items-center gap-8 px-8 text-sm text-white">
            <div className="flex items-center gap-2">
              ...
              <span>Buy 2-4</span>
              <span className="font-bold bg-gradient-to-r from-blue-600 via-sky-500 via-cyan-500 via-teal-500 to-emerald-500 bg-clip-text text-transparent">5% OFF</span>
            </div>
            <span>•</span>
            <div className="flex items-center gap-2">
              <span>Buy 5-9</span>
              <span className="font-bold bg-gradient-to-r from-blue-600 via-sky-500 via-cyan-500 via-teal-500 to-emerald-500 bg-clip-text text-transparent">10% OFF</span>
            </div>
            <span>•</span>
            <div className="flex items-center gap-2">
              <span>Buy 10+</span>
              <span className="font-bold bg-gradient-to-r from-blue-600 via-sky-500 via-cyan-500 via-teal-500 to-emerald-500 bg-clip-text text-transparent">15% OFF</span>
            </div>
            <span>•</span>
          </div>
        </div>
