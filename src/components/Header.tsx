...
export default function Header() {
  ...
  const productsMenu = [
    {
      ...
      items: [
        ...
        { name: "Muff Couplings", url: "/pipe-couplings/muff-couplings" },
      ],
    },
    {
      title: "Valves",
      ...
      items: [
        { name: "Butterfly Valves", url: "/industrial-valves/butterfly-valves" },
        { name: "Check Valves", url: "/industrial-valves/check-valves" },
        { name: "Duckbill Valves", url: "/industrial-valves/duckbill-valves" },
        { name: "Gate Valves", url: "/industrial-valves/gate-valves" },
        { name: "Ball Valves", url: "/industrial-valves/ball-valves" },
        { name: "Float Valves", url: "/industrial-valves/float-valves" },
        { name: "Foot Valves", url: "/industrial-valves/foot-valves" },
      ],
    },
    {
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Basket Strainers", url: "/strainers/basket-strainers" },
        { name: "Duplex Strainers", url: "/strainers/duplex-strainers" },
      ],
    },
  ]
  ...
  const brandsMenu = [
    ...
    { name: "Straub", url: "/pipe-couplings/straub" },
    { name: "Orbit", url: "/pipe-couplings/orbit" },
    { name: "Teekay", url: "/pipe-couplings/teekay" },
