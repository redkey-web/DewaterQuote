                            ...
                            <div className="flex items-center gap-2 mt-1 flex-wrap">
                              ...
                              {item.quantity > 1 && (
                                <>
                                  ...
                                  {hasDiscount ? (
                                    <>
                                      <p className="text-sm line-through text-destructive" data-testid={`text-original-subtotal-${item.id}`}>
                                        ${itemSubtotal?.toFixed(2)}
                                      </p>
                                      <p className="text-sm font-semibold text-primary" data-testid={`text-discounted-subtotal-${item.id}`}>
