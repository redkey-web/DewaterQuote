      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between py-0 gap-6">
          ...
          <Link href="/" className="flex items-center flex-shrink-0 py-0 my-0" data-testid="link-home">
            <img src={logoImage} alt="deWater Products" className="h-[152px] md:h-[180px] object-cover scale-110 block -my-[39px] pt-3 pb-1" style={{ objectPosition: 'center' }} />
          </Link>
        ...
        {mobileMenuOpen && (
          <div className="lg:hidden py-4 border-t border-border">
            ...
            <nav className="space-y-4">
              <Link href="/" className="block text-foreground hover-elevate px-3 py-2 rounded-md" data-testid="link-mobile-home" onClick={() => setMobileMenuOpen(false)}>
                Home
              </Link>
              <Link href="/products" className="block text-foreground hover-elevate px-3 py-2 rounded-md" data-testid="link-mobile-products" onClick={() => setMobileMenuOpen(false)}>
                Products
              </Link>
              <Link href="/industries" className="block text-foreground hover-elevate px-3 py-2 rounded-md" data-testid="link-mobile-industries" onClick={() => setMobileMenuOpen(false)}>
                Industries
              </Link>
              <Link href="/resources" className="block text-foreground hover-elevate px-3 py-2 rounded-md" data-testid="link-mobile-resources" onClick={() => setMobileMenuOpen(false)}>
                Resources
              </Link>
              <Link href="/about" className="block text-foreground hover-elevate px-3 py-2 rounded-md" data-testid="link-mobile-about" onClick={() => setMobileMenuOpen(false)}>
                About
              </Link>
              <Link href="/contact" className="block text-foreground hover-elevate px-3 py-2 rounded-md" data-testid="link-mobile-contact" onClick={() => setMobileMenuOpen(false)}>
                Contact
              </Link>
