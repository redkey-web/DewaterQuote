      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/pipe-repair-clamps/pipe-repair-clamps" className="text-muted-foreground hover:text-foreground" data-testid="link-footer-repair-clamps">Pipe Repair Clamps</Link></li>
              <li><Link href="/pipe-couplings/pipe-couplings" className="text-muted-foreground hover:text-foreground" data-testid="link-footer-pipe-couplings">Pipe Couplings</Link></li>
              <li><Link href="/strainers/basket" className="text-muted-foreground hover:text-foreground" data-testid="link-footer-basket-strainers">Basket Strainers</Link></li>
              <li><Link href="/valves/butterfly-valves" className="text-muted-foreground hover:text-foreground" data-testid="link-footer-butterfly-valves">Butterfly Valves</Link></li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-border text-center text-sm text-muted-foreground">
          ...
          <p className="mt-2">Website Designed by <a href="https://redkey.digital" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">redkey.digital</a></p>
        </div>
      </div>
    </footer>
  );
