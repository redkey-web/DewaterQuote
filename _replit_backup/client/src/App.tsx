        ...
        <Switch>
          ...
          <Route path="/industries/construction">
            <IndustryPage 
              ...
              description="Durable pipe fittings and connections for commercial and residential construction projects. Built to meet Australian building standards and designed for long-term reliability."
              applications={["Commercial buildings", "Residential developments", "Civil infrastructure", "Mechanical services", "Plumbing systems"]}
              onAddToQuote={handleAddToQuote}
            />
          </Route>
